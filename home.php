<?php 
  session_start();
  if(!isset($_SESSION['logado'])){ //se tá logado
    header("Location:login.html");//senão volta pra login
  }
   ?>
<!DOCTYPE html>
...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="masthead">
        <h3 class="text-muted"> Iptables </h3><br> <!-- exibir os menus: Aplicação, about, contact, sair-->
        <ul class="nav nav-justified">
          ...
          <li><a href="contato.php" style="background:#abd3d8">Contato</a></li>
      ...
      <!-- Jumbotron -->
      <div class="jumbotron">
        <h1>Interface Gráfica web para iptables!</h1>
        <p class="lead"> A interface gráfica web para iptables é uma forma amigável de configurar o iptalbes.</p>
